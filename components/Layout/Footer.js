...
const Footer = () => {
  return (
    <Box w="100%" bgColor="black.500" minH={'50vh'}>
      <Grid
        w={'100%'}
        mx="auto"
        maxWidth="80em"
      ...
      >
        <GridItem colSpan={2} display="flex" flexDirection="column">
          <Brand src="/assets/bright.svg" alt="Logo Bright" color="white" w={32} h={24} />
        ...
        <GridItem colSpan={2} colStart={5} display="flex" flexDirection="column">
          <Text color="comet.700" fontSize="xl" fontWeight="700" mb={6}>
            Home
          </Text>
          <List>
